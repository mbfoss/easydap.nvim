...
---@class ezdap.tk.fixedwin.AxisSpec
...
---@type table<string, ezdap.tk.fixedwin.AxisSpec>
local _AXES = {
    height = {
        split = "split",
        fix   = "winfixheight",
...
---@param opts? ezdap.tk.fixedwin.Opts
