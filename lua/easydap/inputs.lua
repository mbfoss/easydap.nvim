...
---@class easydap.FormatDef
---@field type      easydap.InputType   what `build` receives
...
---Every declared `easydap.InputFormat`. `file`/`dir` differ only in the completion
---they drive, not in the value they produce.
---@type table<string, easydap.FormatDef>
M.formats = {
