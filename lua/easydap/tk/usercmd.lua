...
---@alias easydap.tk.usercmd.subcommand_fn fun(cmd:string,rest:string[],arg_lead:string):string[]

---@alias easydap.tk.usercmd.run_fn
---| fun(cmd:string,args:string[],opts:vim.api.keyset.create_user_command.command_args)


---@param subcommand_fn easydap.tk.usercmd.subcommand_fn
...
---@param cmd string
---@param run_fn easydap.tk.usercmd.run_fn
---@param opts {desc:string?,subcommand_fn:easydap.tk.usercmd.subcommand_fn?}?
