...
---@alias easydap.tk.usercmd.subcommand fun(cmd:string,rest:string[],arg_lead:string):string[]

---@alias easydap.tk.usercmd.run_fn
---| fun(cmd:string,args:string[],opts:vim.api.keyset.create_user_command.command_args)


---@param subcommand easydap.tk.usercmd.subcommand
...
---@param cmd string
---@param run_fn easydap.tk.usercmd.run_fn
...
local function _dispatch(cmd, run_fn, opts)
    ...
    if not ok then
        vim.notify(
            "[easydap.tk.nvim] " .. cmd .. " command error\n" .. tostring(err),
...
---@param cmd string
---@param run_fn easydap.tk.usercmd.run_fn
---@param opts {desc:string?,subcommand:easydap.tk.usercmd.subcommand?,count:boolean,range:boolean}?
