---@class easydap.util.Tree.Item
---@field id any
---@field data any

---@class easydap.util.Tree.ItemUpdate
---@field id any
---@field data any
---@field keep_children boolean

---@class easydap.util.Tree.Node
...
---@class easydap.util.Tree.FlatNode
---@field id any
---@field data any
---@field depth integer

---@generic T
---@class easydap.util.Tree
---@field _nodes table<any, easydap.util.Tree.Node>
...
---@private
function Tree:_init()
	---@type table<any, easydap.util.Tree.Node>
	self._nodes = {}
...
---@generic T
---@param parent_id any|nil
---@param items easydap.util.Tree.Item[]
...
---@param parent_id any|nil
---@param items easydap.util.Tree.ItemUpdate[]
...
---@private
---@param node easydap.util.Tree.Node
