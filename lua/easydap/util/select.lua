---@brief Standalone floating fuzzy picker for easydap.
...
local _NS_PREVIEW        = vim.api.nvim_create_namespace("easydap_select_preview")

local _antiflicker_delay = 200

---@class easydap.select.ItemData
---@field filepath string?
---@field lnum integer?
---@field col integer?
---@field [string] any

---@class easydap.select.Item
---@field label string  -- display text; fuzzy-matched and match-highlighted
---@field data easydap.select.ItemData?  -- passed to the callback and previewer

---@class easydap.select.Preview
...
---@alias easydap.select.Previewer fun(data:any, callback:fun(preview:easydap.select.Preview?)):(fun()?)

---@class easydap.select.Opts
---@field prompt string?
...
---@param items easydap.select.ListItem[]
...
---@type easydap.select.Picker?
local _active_picker = nil

---@class easydap.select.Picker
---@field opts easydap.select.Opts
---@field callback fun(data:any?)
---@field preview_enabled boolean
---@field layout easydap.select.Layout
...
---@field lwin integer?
---@field vwin integer?
---@field list_items easydap.select.ListItem[]
...
---@param opts easydap.select.Opts
